<#
	...
	Version : 1.1
	History : 1.1  changed Int32 ptr = userRightsPtr.ToInt32(); to Int64 ptr = userRightsPtr.ToInt64();
					to avoid CallDepthOverflow Errors
            ...
            else
            {
                ...
                else
                {
                    try
                    {
                        ...
                        //PL, Int32 ptr = userRightsPtr.ToInt32();
